...
def RunQueryEpoch(split,
    ...
    for step in range(num_batch):
        ...
        loss = QError(actual_cards, est_sels).mean()
        ...
        if step % log_every == 0:
            print('Epoch {} Iter {}, {} loss {:.4f}'.format(epoch_num, step, split, loss.item()))
...
def TrainTask(seed=0, rng=None):
    ...
    for epoch in range(args.epochs):
        ...
        if not args.run_uaeq:
            ...
            PATH = 'models/uaeq-{}-q_bs-{}-{}epochs-psample-{}-seed-{}-tau-{}-layers-{}-lr-{}-queries-{}.pt'.format(
                args.dataset, q_bs, epoch, args.psample, seed, tau,  args.layers, args.constant_lr, args.workload_size)
