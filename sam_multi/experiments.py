...
TEST_CONFIGS['job-light-ranges-reload-pg'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges'],
    **{
        'queries_csv': './queries/job-light-train-subs.csv',
        'checkpoint_to_load': 'models/imdb-uae-q-1.pt',
        'eval_psamples': [1000, 8000],
...
TEST_CONFIGS['job-light-ranges-test'] = dict(
    EXPERIMENT_CONFIGS['job-light-ranges'],
    **{
        'queries_csv': './queries/job-light-refined.csv',
...
TEST_CONFIGS['job-light-test'] = dict(
    EXPERIMENT_CONFIGS['job-light'],
    **{
        'queries_csv': './queries/job-light.csv',
        'checkpoint_to_load': 'models/imdb-uae-q-1.pt',
...
TEST_CONFIGS['job-m-reload-pg'] = dict(
    EXPERIMENT_CONFIGS['job-m'],
    **{
        'queries_csv': './queries/job-m-subs.csv',
...
TEST_CONFIGS['job-m-range-reload-pg'] = dict(
    EXPERIMENT_CONFIGS['job-m'],
    **{
        'queries_csv': './queries/job-m-range-subs.csv',
        'checkpoint_to_load': 'models/job-m-range-pretrained.pt',
        'eval_psamples': [1000, 8000],
        'use_cols': 'multi-content',
        # Evaluating on all queries takes a while.  Shorten the wait by
        # setting this flag (adjust asserts too) during testing:
