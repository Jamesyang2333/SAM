...
class DifferentialbleProgressiveSampling(CardEst):
    """Progressive sampling."""
    ...
    def __init__(
        ...
        super(DifferentialbleProgressiveSampling, self).__init__()
        torch.set_grad_enabled(False)
        self.model = model
        self.model.eval()
        self.table = table
...
class DifferentialbleFactorizedProgressiveSampling(DifferentialbleProgressiveSampling):
    """Additional logic for handling column factorization."""
    ...
    def __init__(self,
        ...
        super(DifferentialbleFactorizedProgressiveSampling,
              self).__init__(model, fact_table, r, join_spec, device, seed,
